...
/****** Object:  StoredProcedure [dbo].[GGSP_RemoveUserFromRole]    Script Date: 12/22/2021 4:20:01 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Procedure to remove a User from an Existing Role>
-- =============================================
CREATE PROCEDURE [dbo].[ESPSP_RemoveUserFromRole]
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			DELETE FROM UserRoleMembership
		...
		ELSE
		BEGIN
			RETURN 'Error: User is not a memeber of this role.'
		END
	END
END
GO
