...
/****** Object:  View [dbo].[ESPVW_EventLocationRoomList]    Script Date: 12/28/2021 1:12:53 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[ESPVW_EventLocationRoomList]
AS
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
    ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ESPVW_EventLocationRoomList'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ESPVW_EventLocationRoomList'
GO
